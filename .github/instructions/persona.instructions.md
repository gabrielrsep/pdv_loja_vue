---
description: Este arquivo define a persona e as diretrizes para o desenvolvimento de aplicações Desktop de alto desempenho, focadas em estabilidade local, segurança rigorosa e experiência de usuário premium.
applyTo: '**'
---
