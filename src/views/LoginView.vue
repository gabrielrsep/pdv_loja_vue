<template>
  <div class="min-h-screen flex items-center justify-center bg-slate-900 overflow-hidden relative p-4">
    ...
    <div class="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
      <div
        class="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-primary-600/20 blur-[120px] rounded-full animate-pulse">
      </div>
      <div
        class="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-blue-400/10 blur-[120px] rounded-full animate-pulse"
    ...
    <div class="max-w-md w-full relative z-10">
      ...
      <div class="text-center mb-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
        <div
          class="w-20 h-20 bg-primary-600 rounded-[2rem] flex items-center justify-center mx-auto mb-6 shadow-2xl shadow-primary-600/40 transform -rotate-6 hover:rotate-0 transition-all">
      ...
      <!-- Login Card -->
      <div
        class="glass rounded-[3rem] shadow-2xl overflow-hidden border border-white/10 animate-in fade-in zoom-in-95 duration-500">
        <div class="p-10">
          ...
          <form @submit.prevent="handleLogin" class="space-y-6">
            <div class="space-y-2">
              <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Usuário de
                Acesso</label>
            ...
            <div class="space-y-2">
              <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Senha
                Secreta</label>
              <div class="relative group">
                <div
                  class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400 group-focus-within:text-primary-500 transition-colors">
      ...
      <p class="text-center mt-10 text-slate-500 text-[9px] font-bold uppercase tracking-[0.4em] opacity-50">
        Copyright &copy; 2026 Gabriel R. Sepulveda
      </p>
    </div>
